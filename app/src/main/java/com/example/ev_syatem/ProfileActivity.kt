    ...
    private fun updateUserProfile() {
        ...
        CoroutineScope(Dispatchers.IO).launch {
            try {
                ...
                // Use 172.20.10.9 for Android emulator to reach localhost of host
                val request = Request.Builder()
                    .url("http://172.20.10.9:8080/api/users/$userId")
                    .put(requestBody)
                    .build()
    ...
    private fun deactivateAccount() {
        CoroutineScope(Dispatchers.IO).launch {
            try {
                ...
                val request = Request.Builder()
                    .url("http://172.20.10.9:8080/api/users/$userId/deactivate")
